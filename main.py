...
if uploaded_file:
    ...
    client = OpenAI(
    api_key="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"
    )
